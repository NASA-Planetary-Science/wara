...
class SpectrumMixin:
    ...
    def get_values_table_fit(self):
        ...
        # PeakFit reports the area as net counts (the spectrum's native
        # y-units), so "Peak area" is shown directly and stays consistent
        # with the plotted counts and the net-area method.
        mean = []
        area = []
        fwhm = []
        fwhm_p = []
